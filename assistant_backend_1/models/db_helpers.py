# db_helpers.py
# Drop-in replacement for helpers.py — uses Postgres instead of JSON file
...
def save_user(chat_id: str, first_name: str = None, username: str = None) -> dict:
    try:
        ...
        print(f" User saved to Postgres: {chat_id}")
        return user
...
def load_users() -> dict:
    # Not needed with Postgres — kept for compatibility
    return {}
